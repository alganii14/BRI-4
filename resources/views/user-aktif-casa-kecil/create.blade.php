...
@section('title', 'Tambah User Aktif Casa Kecil')
@section('page-title', 'Tambah Data User Aktif Casa Kecil')
...
<div class="form-container">
    <form action="{{ route('user-aktif-casa-kecil.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="saldo_bulan_lalu" name="saldo_bulan_lalu" value="{{ old('saldo_bulan_lalu') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="saldo_bulan_berjalan" name="saldo_bulan_berjalan" value="{{ old('saldo_bulan_berjalan') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="delta_saldo" name="delta_saldo" value="{{ old('delta_saldo') }}">
                @error('delta_saldo')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_rm_pemrakarsa" name="nama_rm_pemrakarsa" value="{{ old('nama_rm_pemrakarsa') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="qcash" name="qcash" value="{{ old('qcash') }}">
                @error('qcash')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="qib" name="qib" value="{{ old('qib') }}">
                @error('qib')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
