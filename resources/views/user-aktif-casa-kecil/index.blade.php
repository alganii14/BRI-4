    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Saldo Bulan Berjalan</th>
                <th>Delta Saldo</th>
                <th>Nama RM Pemrakarsa</th>
                <th>QCash</th>
                <th>QIB</th>
                <th>Actions</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->saldo_bulan_lalu }}</td>
                <td>{{ $item->saldo_bulan_berjalan }}</td>
                <td class="{{ strpos($item->delta_saldo, '-') === 0 ? 'delta-negative' : 'delta-positive' }}">
                    {{ $item->delta_saldo }}
                </td>
                <td>{{ $item->nama_rm_pemrakarsa }}</td>
                <td>{{ $item->qcash }}</td>
                <td>{{ $item->qib }}</td>
                <td>
                    <div class="actions">
