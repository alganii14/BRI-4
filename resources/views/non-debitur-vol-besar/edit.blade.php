...
@section('page-title', 'Edit Data Non Debitur Vol Besar CASA Kecil')
    ...
    <form action="{{ route('non-debitur-vol-besar.update', $nonDebiturVolBesar->id) }}" method="POST">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="no_rekening" name="no_rekening" value="{{ old('no_rekening', $nonDebiturVolBesar->no_rekening) }}">
                @error('no_rekening')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="segmentasi" name="segmentasi" value="{{ old('segmentasi', $nonDebiturVolBesar->segmentasi) }}">
                @error('segmentasi')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="vol_qcash" name="vol_qcash" value="{{ old('vol_qcash', $nonDebiturVolBesar->vol_qcash) }}">
                @error('vol_qcash')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="vol_qib" name="vol_qib" value="{{ old('vol_qib', $nonDebiturVolBesar->vol_qib) }}">
                @error('vol_qib')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="saldo" name="saldo" value="{{ old('saldo', $nonDebiturVolBesar->saldo) }}">
                @error('saldo')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
