...
@section('title', 'Tambah Penurunan Casa Brilink')
@section('page-title', 'Tambah Data Penurunan Casa Brilink')
...
<div class="form-container">
    <form action="{{ route('penurunan-casa-brilink.store') }}" method="POST">
        @csrf
