...
@section('title', 'Tambah Penurunan Merchant')
@section('page-title', 'Tambah Data Penurunan CASA Merchant (QRIS & EDC)')
...
<div class="form-container">
    <form action="{{ route('penurunan-merchant.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select id="segmentasi" name="segmentasi">
                    ...
                    <option value="MIKRO" {{ old('segmentasi') == 'MIKRO' ? 'selected' : '' }}>MIKRO</option>
                    <option value="RITEL" {{ old('segmentasi') == 'RITEL' ? 'selected' : '' }}>RITEL</option>
                </select>
                @error('segmentasi')
                    <span class="error">{{ $message }}</span>
                @enderror
