...
@section('title', 'Tambah AUM DPK')
@section('page-title', 'Tambah Data AUM>2M DPK<50 juta')
...
<div class="form-container">
    <form action="{{ route('aum-dpk.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="slp" name="slp" value="{{ old('slp') }}">
                @error('slp')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="pbo" name="pbo" value="{{ old('pbo') }}">
                @error('pbo')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="id_prioritas" name="id_prioritas" value="{{ old('id_prioritas') }}">
                @error('id_prioritas')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="aum" name="aum" value="{{ old('aum') }}">
                @error('aum')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
