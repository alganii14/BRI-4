...
@section('title', 'Tambah Penurunan Prioritas Ritel & Mikro')
@section('page-title', 'Tambah Data Penurunan Prioritas Ritel & Mikro')
...
<div class="form-container">
    <form action="{{ route('penurunan-prioritas-ritel-mikro.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" id="saldo_last_eom" name="saldo_last_eom" value="{{ old('saldo_last_eom') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" id="saldo_terupdate" name="saldo_terupdate" value="{{ old('saldo_terupdate') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" id="delta" name="delta" value="{{ old('delta') }}">
                @error('delta')
                    <span class="error">{{ $message }}</span>
                @enderror
            </div>
