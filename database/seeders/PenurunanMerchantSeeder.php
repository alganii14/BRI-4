...
class PenurunanMerchantSeeder extends Seeder
{
    public function run()
    {
        ...
        for ($i = 1; $i <= 500; $i++) {
            $idx = $i % 5;
            $saldoLastEom = rand(20000000, 300000000);
            $saldoTerupdate = $saldoLastEom - rand(5000000, 100000000);
            
            PenurunanMerchant::create([
                ...
                'no_rekening' => '600' . str_pad($i, 10, '0', STR_PAD_LEFT),
                'nama_nasabah' => 'Merchant ' . $i,
