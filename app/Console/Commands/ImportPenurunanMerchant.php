...
class ImportPenurunanMerchant extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import:penurunan-merchant {file}';
     ...
     * @var string
     */
    protected $description = 'Import Penurunan Merchant data from CSV file';
