...
class ImportQlolaNonDebitur extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import:qlola-non-debitur {file}';
     ...
     * @var string
     */
    protected $description = 'Import Qlola Non Debitur data from CSV file';
